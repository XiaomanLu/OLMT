...
if (runtype == 'site'):
    ...
    region_name = 'ORNL'  #Set the name of the region/point list to be simulated
    numproc =             #Number of processors, must be <= the number of active gridcells
    if (runtype == 'latlon_list'):
        point_list_file = '/ccsopen/home/zdr/models/OLMT/point_lists/JBL_sites.txt'   #List of lat lons
#If neither point_list or site is defined, it will use the bounds below.
lat_bounds = [35.90,35.95]   
lon_bounds = [-84.34,-84.29]
#lat_bounds = [41.5,42] 
#lon_bounds = [-88,-87.5] #-84.5,-84]
...
nyears_final   =  44      #number of years for final spinup OR for SP run
...
case_options['metdir'] = '/gpfs/wolf2/cades/cli185/world-shared/e3sm/inputdata/atm/datm7/Daymet_ERA5_TESSFA1/cpl_bypass_full/'
...
case_options['use_obs_zwt'] = '.false.'
