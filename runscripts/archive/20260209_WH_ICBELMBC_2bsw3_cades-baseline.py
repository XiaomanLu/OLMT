...
case_suffix = '2bsw3'           #Identifier for cases (leave blank if none); 0dot7BSW
...
case_options['surffile'] = inputdata+f'/lnd/clm2/PTCLM/1x1pt_KNX-{sites}/surfdata_r20.nc' #_aveDTB.nc'
