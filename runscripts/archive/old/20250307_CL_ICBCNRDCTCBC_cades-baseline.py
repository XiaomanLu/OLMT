...
#----------------------Required inputs---------------------------------------------
sites = sys.argv[1]               #Site or list of sites (6-character FLUXNET ID) or 'all for all sites in group
# sites = 'SD'
...
nyears_trans   =  175 - 0      #number of years for transient run 
...
case_options['pftdynfile'] = inputdata+f'/lnd/clm2/PTCLM/1x1pt_KNX-{sites}/surfdata.pftdyn_r5.nc'
