...
case_options['add_co2'] = 0
case_options['startdate_add_co2'] = f"{run_startyear}0101"
...
startyear_treatment = run_startyear + nyears_trans - 10   #Starting year (assuming to start from end of transient
treatment_options={}
