...
case_suffix = '_tripleKsat'           #Identifier for cases (leave blank if none)
...
case_options['surffile'] = inputdata+f'/lnd/clm2/PTCLM/1x1pt_KNX-{sites}/surfdata_r20_aveDTB.nc'
